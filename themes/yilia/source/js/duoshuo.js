! function(e, t, s) {
    ...
    function i() {
        ...
        "Notification" in e && "denied" !== s.permission && ("granted" === s.permission && t(), s.requestPermission(function(e) { "granted" === e && t() }))
    }
    ...
    function n(e) { S.theme = e, "none" != e && o.injectStylesheet(S.STATIC_URL + "/styles/embed" + (e ? "." + e + ".css?" + A[e] : "." + short_name) + ".css") }
    var o = {},
    ...
    if (o.extend = function(e, t) {
        ...
        var c, u, p = e.JSON,
            ...
            C = function(e) {
                return e && e.error && e.warn ? e : { error: function() {}, log: function() {}, warn: function() {} }
            }(e.console),
            S = e.DUOSHUO = {
                sourceName: { weibo: "新浪微博", qq: "QQ", qzone: "QQ空间", qqt: "腾讯微博", renren: "人人网", douban: "豆瓣网", kaixin: "开心网", sohu: "搜狐微博", baidu: "百度", google: "谷歌", wechat: "微信", weixin: "微信", facebook: "Facebook", twitter: "Twitter", linkedin: "Linkedin" },
                serviceNames: { weibo: "微博", qq: "QQ", douban: "豆瓣", renren: "人人", kaixin: "开心", baidu: "百度", google: "谷歌", wechat: "微信", weixin: "微信", facebook: "Facebook", twitter: "Twitter", linkedin: "Linkedin" },
                ...
                init: function(e, t) { e && !O[e] && (O[e] = t || { type: "EmbedThread" }), S.initView && S.initView() }
            },
            j = t.all,
        ...
        for (var N = 0, I = ["EmbedThread", "RecentComments", "RecentVisitors", "TopUsers", "TopThreads", "LoginWidget", "ThreadCount"]; N < I.length; N++) S[I[N]] = function(e) {
            return function(t, s) { s = s || {}, s.type = e, t && !O[t] && (O[t] = s), S.initSelector && S.initSelector(t, s) }
                ...
                ajax: function(e, t, i, r, n) {
                    ...
                    function l(e, t, s) {
                        ...
                        if (e >= 200 && 300 > e || 304 === e)
                            ...
                            else try { a = p.parse(s), l = "success", o = !0 } catch (c) { l = "parsererror", i = c } else {
            ...
            M = S.ws = {
                ...
                send: function(s) {
                    ...
                    if (a.messages.push(p.stringify(s)), !a.webSocket) {
                        ...
                        }, e.addEventListener("beforeunload", function() { n.close() })
                    }
                    a.webSocket.onopen()
                }
            };
        S.DOMAIN = "duoshuo.com", S.STATIC_URL = g + "//static.duoshuo.com", S.REMOTE = g + "//duoshuo.com", S.version = "16.3.18";
        var A = { "default": "9b2a46a0", dark: "33f3a5ac", bluebox: "39a75d50", newhua: "706ba4eb", justflat: "9d72ec5a" },
            ...
            W = S.loadRequire = function(t) {
                if (t.visitor && (!nt.data && t.visitor.user_id && e.Notification && M.send({ logged_user_id: t.visitor.user_id }), nt.reset(t.visitor)), t.site && (rt.reset(t.site), z.save("ds_site_" + c.short_name, t.site)), !S.theme && rt.data.theme && n(rt.data.theme), t.lang && (o.extend(D, t.lang), z.save("ds_lang_" + c.short_name, t.lang)), t.stylesheets)
        ...
        var J = S.Event = H.extend({
            ...
            Q = S.Widget = J.extend({
                init: function(e, t) { this.el = e, this.options = t || {}, this.render() },
                render: function() {},
                reset: function() {},
                load: function(e) {
                    switch (e.code) {
                ...
                onload: function(e) { this.el.html(et[this.tmpl](e)) },
                prepare: function(e) {
                    return e
                },
                onMessage: function() {},
                onError: function(e) { C.error("出错啦(" + e.code + "): " + e.errorMessage), e.errorTrace && C.error(e.errorTrace) }
            }),
            V = S.Model = J.extend({
                init: function(e) { this.data = e },
                reset: function(e) { this.data = e, this.trigger("reset") },
                remove: function(e) { this.data.splice(e, 1), this.trigger("reset") },
                set: function(e, t) {
                    if (t === s)
        ...
        var Z = {
                ...
                avatarUrl: function(e) {
                    ...
                    if (avatar_url) {
                        if (avatar_url.indexOf("q.qlogo.cn") !== -1) {
                            return avatar_url.replace("http:", "https:");
                        } else {
                            return avatar_url.replace(/^http\:\/\//, "https://dn-inode.qbox.me/");
                        }
                    } else {
        ...
        et.commentList = function(e) {
            ...
            if (s.message.indexOf("http:") != -1) {
                s.message = s.message.replace(/http\:\/\//g, "https://dn-inode.qbox.me/");
            }
        ...
        it.on("queryDefined", function() {
            ...
            function T(e) {
                ...
                }).delegate(".ds-read", "click", function() { t.read(H(this).parent()) });
            ...
            function B(e) {
                var s = { require: "site,visitor,nonce,lang" + (it++ ? "" : ",unread,log,extraCss"), site_ims: z.get("ds_site_" + c.short_name + ":timestamp"), lang_ims: z.get("ds_lang_" + c.short_name + ":timestamp"), referer: t.referrer };
            ...
            e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)), S.scrollTo = function(e) {
                ...
                var t = /\r?\n/g,
                    ...
                    r = {};
                return H.each(i, function() { r[this.name] = this.value }), r
            ...
            }, ot.on("reset", S.resetNotify), st.Replybox = function(e) { this.embedThread = e }, st.Replybox.prototype = {
                render: function(e) {
                    function s(e) { e.data("submitting", !0), e.find(".ds-post-button").addClass("ds-waiting").html(D.posting)[0].disabled = !0 }

                    function a(e) { e.data("submitting", !1), e.find(".ds-post-button").removeClass("ds-waiting").html(D.post)[0].disabled = !1 }
                    var i = this,
                        o = i.embedThread,
                        c = o.options,
                    ...
                    var g = i.el = H(et.replybox(h)).click(p),
                        ...
                        x = (g.find(".ds-add-image").click(function(e) {
                            ...
                            e.preventDefault()
                        }), i.hideSmilies = function() { w.removeClass("ds-expanded"), S.smiliesTooltip.el.detach(), H(t.body).unbind("click", x) }),
                        T = function(e, t) {
                    ...
                    var q = function(e) {
                        s(b), R.post("posts/create", H.extend(S.toJSON(b), e), function(e) {
                            var t = lt[e.response.post_id] = new F(e.response),
                                s = A(i.postList, t, c);
                            if ("asc" == c.order == ("top" == c.formPosition) && S.scrollTo(s), o.data.comments++, o.updateCounter("duoshuo"), k.val("").trigger("keyup"), a(b), g.hasClass("ds-inline-replybox") && (g.detach(), i.actionsBar.removeClass("ds-reply-active")), m) try { m.removeItem("ds_draft_" + o.threadId) } catch (r) {}
                        }, function(e) { a(b), alert(e.errorMessage) })
                    };
                    b.submit(function() {
                ...
                open: function() {
                    ...
                    return a.el.hide().appendTo(t.body).fadeIn(200), P.ie6 && a.el.css("top", V.scrollTop() + 100), a.el.show().find(".ds-dialog").delegate("a.ds-dialog-close", "click", function() {
                        return a.close(), !1
                    }).click(i), G.keydown(e), H(t.body).click(s), a.close = function() { G.unbind("keydown", e), H(t.body).unbind("click", s), a.el.fadeOut(200, function() { H(this).remove() }), a.trigger("close") }, a
                }
            }), et.likePanel = function(e) {
                return e.likes ? '<span class="ds-highlight">' + e.likes + "</span> 人喜欢" : ""
            }, st.Meta = function(e) { this.embedThread = e }, st.Meta.prototype = {
                render: function() {
                    function a(a) {
                ...
                resetLikePanel: function() { this.el.find(".ds-like-panel").html(et.likePanel(this.embedThread.model.toJSON())) }
            }, st.PostListHead = function(e) { this.embedThread = e }, st.PostListHead.prototype = {
                render: function() {
                    function e(e) {
                ...
                render: function() {
                    ...
                    return a.click(i).find("ul.ds-smilies-tabs").delegate("a", "click", function() { s.reset(this.innerHTML) }), a.find(".ds-smilies-container").delegate("img", "click", e), this
                },
                reset: function(e) {
                    function t(t, s) {
                        ...
                        i = i.replace("http://", "https://dn-inode.qbox.me/");
            ...
            var X = H('<div id="ds-bubble"><div class="ds-bubble-content"></div><div class="ds-arrow ds-arrow-down ds-arrow-border"></div><div class="ds-arrow ds-arrow-down"></div></div>'),
                ...
                tt = bubbleOutTimer = 0;
            X.mouseenter(N).mouseleave(I), st.PostList = function(e) { e && (e.params && (this.params = e.params), e.embedThread && (this.embedThread = e.embedThread)), this.el = H('<ul class="ds-comments"></ul>') }, st.PostList.prototype = {
            ...
            }, st.RelatedRead = function() { this._init() }, st.RelatedRead.prototype = {
                uri: "base/recommend",
                ...
                _init: function() { this.el = H('<div id="ds-related-reads"></div>'), this._count_timer = null },
                ...
                _transform: function(e) {
                    for (var t = [], s = 0, a = e.length; a > s; s++) t.push({ url: e[s].url, title: e[s].title, type: e[s].type, source: e[s].source, imgs: this._unpackImages(e[s]), timeStamp: 1e3 * e[s].publish_time, hasVideo: e[s].has_video, videoDuration: this._parseVideoDuration(e[s].video_duraion) });
                    return t
                },
                ...
                load: function(e) {
                    var t = this;
                    R.get(this.uri, { thread_id: e, url: h.href }, function(e) { 0 == e.code ? t.render(e.response) : t.renderError() })
                },
                mount: function(e) {
                ...
                stopCount: function() { clearTimeout(this._count_timer) }
                ...
                updateCounter: function(e) {
                    ...
                    var s = { duoshuo: ["comments", t(D.comments_multiple) || "评论"], repost: ["reposts", t(D.reposts_multiple) || "转载"], weibo: ["weibo_reposts", t(D.weibo_reposts_multiple) || "新浪微博"], qqt: ["qqt_reposts", t(D.qqt_reposts_multiple) || "腾讯微博"] };
                    for (var a in s)
                        if (!e || e == a) {
                ...
                onError: function(e) { this.el.html("评论框出错啦(" + e.code + "): " + e.errorMessage) },
                onload: function(t) {
                    var a = this,
                    ...
                    }).delegate("a.ds-service-link", "click", l) : a.toolbar = H(et.toolbar()).delegate(".ds-account-control", "mouseenter", function() { H(this).addClass("ds-active") }).delegate(".ds-account-control", "mouseleave", function() { H(this).removeClass("ds-active") }).delegate("a.ds-bind-more", "click", function() {
                ...
                onload: function(e) { e.options = H.extend(this.options, e.options), Q.prototype.onload.call(this, e), U.call(this.el.find("ul"), this.thread, this.options) }
                ...
                render: function() { this.el.attr("id", "ds-recent-comments") },
                prepare: function(e) {
                    return {
                ...
                delegateEvents: function() {
                    ...
                    if (i.children().hasClass("ds-share-inline")) {
                        ...
                        i.delegate(d, "mouseover", function() { n.show() }), i.delegate(d, "mouseout", function() { n.hide() }), i.delegate(r, "mouseover", function() { n.show() }), i.delegate(r, "mouseout", function() { n.hide() })
                    } else {
            ...
            S.initSelector = function(e, t) {
                function s(e) { W(e), o.extend(D, e.options), dt.set(e.response) }
                var a = [];
                !q() || !H.isReady && j || H(e).each(function(e, s) {
                    ...
                    if (!i.data("initialized")) {
                        ...
                        if (at.push(r), "ThreadCount" === t.type) {
                            ...
                            i.attr("data-channel-key") && (n = i.attr("data-channel-key") + ":" + n), a.push(n), dt[n] || (dt[n] = new Y({})), dt[n].on("reset", function() { r.onload(this) })
                        } else if (r.uri) {
                            var o = {};
                            H.each(r.params.split(" "), function(e, t) { o[t.replace(/-/g, "_")] = i.attr("data-" + t) || i.data(t) }), R.get(r.uri, B(o), function(e) { r.load(e) })
                        }
                    }
                }), a.length && R.get("threads/counts", B({ threads: a.join(",") }), s)
            }, (S.initView = function() { H.each(O, S.initSelector) })(), H(function() {
                if (!c) {
